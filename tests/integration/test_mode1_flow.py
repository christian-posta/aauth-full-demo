...
@pytest.mark.mode1
def test_supply_chain_optimization_flow(backend_url):
    """
...
@pytest.mark.mode1
def test_market_analysis_request(backend_url):
    """
...
@pytest.mark.mode1
def test_empty_request_prompt(backend_url):
...
@pytest.mark.mode1
def test_multiple_concurrent_requests(backend_url):
...
@pytest.mark.mode1
def test_mode1_no_user_interaction(backend_url):
