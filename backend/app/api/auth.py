...
async def _resume_pending_request(request_id: str) -> None:
    ...
    try:
        ...
        token_result = await aauth_token_service.poll_for_auth_token(pending["pending_url"])
